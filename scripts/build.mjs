...
/** All @deepseek-ai imports stay external on both halves. */
const deepseekExternal = (source) => source.startsWith('@deepseek-ai/')
...
for (const file of clientCtx.outputFiles) {
...
console.log('build complete: lib/index.js (node), lib/client.js (client factory)')
